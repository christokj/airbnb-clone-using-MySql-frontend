...
function PlaceGallery({ place }) {
        ...
        <div className="max-sm:m-1 max-md:m-2 m-8 grid gap-4">
          <div className="mb-4">
            ...
            <button
              ...
              className="fixed bg-opacity-30 flex rounded-full  bg-gray-100 hover:bg-gray-300 text-black font-semibold"
            >
  ...
  return (
    <div className="image_wrapper grid gap-2 grid-cols-[2fr_1fr] relative">
      ...
      <button
        onClick={() => setShowAllPhotos(true)}
        className="max-sm:px-0 flex absolute bottom-6 right-2 bg-opacity-40 bg-white hover:bg-white text-black font-semibold py-1 px-2 rounded-full"
      >
        <svg
          className="max-sm:w-3 w-5 mx-1 my-1 "
